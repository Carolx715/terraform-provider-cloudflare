		...
		Steps: []resource.TestStep{
			...
			// },
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					// statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("rules").AtSliceIndex(1).AtMapKey("id"), knownvalue.StringExact("cleanup-multipart")),
					...
					// statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("rules").AtSliceIndex(2).AtMapKey("id"), knownvalue.StringExact("delete-old-objects")),
